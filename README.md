...
A [codesandbox example](https://codesandbox.io/s/github/jakub-musik/react-router-permissions/tree/master/example/) is available.

[![Edit React Router Permissions - Basic Usage](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/jakub-musik/react-router-permissions/tree/master/example/?fontsize=14)
